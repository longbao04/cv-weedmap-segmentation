...
15. 目前真实 WeedMap 实验最推荐报告多 seed 平均结果，而不是某一次单独训练结果；Epoch 20 指标回落也进一步说明 best checkpoint 必不可少。
