...
上述结果用于计划中的 MobileNetV3-YOLOv8n 轻量化改造 baseline，目前尚未实现该模型。未来修改 YOLO backbone 时，需在一致条件下同时比较 detection metrics 与 lightweight metrics：Params、FLOPs、model size、inference speed。
